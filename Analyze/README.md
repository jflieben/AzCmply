...
| AzCmply Custom | 2026.09.3 | JSolve's own controls | 13 |
...
- AzCmply Custom: JSolve's controls for Azure attack paths and risks that none of the other frameworks covers, based on published attack research and breaches (for example the shared service tag bypass of Tenable TRA-2024-19). Its 21 tests (AZ-IAM-031 to 033, AZ-NET-026, AZ-NET-027, AZ-APP-010, AZ-APP-011, AZ-APP-013, AZ-VM-014 to 016, AZ-STG-027, AZ-GOV-014, AZ-LOG-027 to 029, AZ-APIM-008, AZ-LOGIC-002, AZ-LOGIC-009, AZ-FUNC-001, AZ-FUNC-003) evidence no control of another framework.
