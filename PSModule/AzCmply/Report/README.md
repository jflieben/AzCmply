...
5. Framework compliance: a card per benchmark (MCSB v2, CIS Azure 6.0.0, WAF, ALZ) with version, publisher and source, the derived frameworks (NIST SP 800-53, PCI DSS, ISO 27001, CIS Controls, NIST CSF, SOC 2), and a control table per framework. Controls link to their source documentation where one exists; derived controls show the MCSB controls they come from.
