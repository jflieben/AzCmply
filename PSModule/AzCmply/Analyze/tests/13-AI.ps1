#AI services: Azure AI Services / Azure OpenAI (Foundry) accounts and Azure Machine Learning workspaces
...
Add-AzTest @{
    ...
    Frameworks    = @{ MCSB = @('IM-1', 'IM-3'); WAF = 'SE:05'; ALZ = @('Enforce-GR-CogServ0', 'Enforce-GR-OpenAI0') }
...
Add-AzTest @{
    ...
    Frameworks    = @{ MCSB = 'NS-2'; WAF = 'SE:06'; ALZ = @('Enforce-GR-CogServ0', 'Enforce-GR-OpenAI0', 'Deny-Public-Endpoints') }
...
Add-AzTest @{
    ...
    Frameworks    = @{ MCSB = @('AI-4', 'DP-2'); WAF = 'SE:06' }
    ResourceTypes = $aiType
    Evaluate      = {
        param($Record)
        $p = $Record.resource.properties
...
Add-AzTest @{
    ...
    Frameworks    = @{ MCSB = 'NS-2'; WAF = 'SE:06'; ALZ = @('Enforce-GR-MachLearn0', 'Deny-Public-Endpoints') }
...
Add-AzTest @{
    ...
    Frameworks    = @{ MCSB = @('NS-2', 'DP-2'); ALZ = 'Enforce-GR-MachLearn0' }
...
Add-AzTest @{
    ...
    Frameworks  = @{ MCSB = @('IM-1', 'NS-2'); ALZ = 'Enforce-GR-MachLearn0' }
